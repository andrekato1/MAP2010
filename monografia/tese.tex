...
\title{
    ...
    titlept={Simulation of a self-parking car using deep reinforcement learning},
    titleen={Simulation of a self-parking car using deep reinforcement learning},
    % Opcional, mas se houver deve existir nas duas línguas
    %subtitlept={um subtítulo},
    %subtitleen={a subtitle},
}

\author[masc]{André Shumhei Kato}

% Para TCCs, este comando define o supervisor
\orientador[masc]{Prof. Dr. Alexandre Megiorin Roma}
...
\begin{dedicatoria}
  Dedico esse trabalho ao meu pai e maior mentor, Marco, pelo apoio incondicional durante toda a minha trajetória e por nunca ter medido esforços para me ajudar, me permitindo seguir meus sonhos.
\end{dedicatoria}
...
\epigrafe{Fall seven times, get up eight.}{Japanese Proverb}

Ao meu orientador Alexandre Roma por toda a sua atenção, cuidado e orientação.

Aos meus amigos Vinícius Moreno e Lucas Dário pelas suas contribuições ao longo da realização desse trabalho

Ao meu amigo Kauer Kitzinger d'Avila por ajudar na revisão da monografia.

Aos meus amigos Victor, Luma, João, Yukio, Andrew, Carlos Wellington e muitos outros que gostaria de adicionar à já extensa lista, pelos momentos de diversão e descompressão.

Aos professores David Silver da University College London e Emma Brunskill de Stanford por disponibilizar gratuitamente aulas e materiais de estudo.

Ao \href{https://arztsamuel.github.io/index.html}{Samuel Arzt} da University of Applied Sciences Salzburg, autor do \href{https://www.youtube.com/watch?v=VMp6pq6_QjI&ab_channel=SamuelArzt}{vídeo} que motivou e inspirou a realização desse trabalho.
...
\input{conteudo/00-preliminaries}
\input{conteudo/01-introduction}
\input{conteudo/02-mdp}
\input{conteudo/03-neural-networks}
\input{conteudo/04-ppo}
\input{conteudo/05-experiments}

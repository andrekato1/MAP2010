...
%Agradeço e dedico esse trabalho ao meu pai e maior mentor, Marco, pelo apoio incondicional durante toda a minha trajetória e por nunca ter medido esforços para me ajudar, me permitindo seguir meus sonhos. Agradeço ao meu orientador Alexandre Roma por toda a sua atenção, cuidado e orientação durante a realização desse trabalho. Por fim, agradeço aos meus amigos Arthur, Vinícius, Luma, João, Victor, Yukio e muitos outros que gostaria de adicionar à já extensa lista, por ajudarem a tornar leves os dias duros. 
...
\input{conteudo/04-policy-gradient}
\input{conteudo/05-trpo}
\input{conteudo/06-experiments}

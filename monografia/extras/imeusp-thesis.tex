...
\@ifpackageloaded{fontspec}
  {\providecommand{\@macCDXCIX}{map~\oldstylenums{2010}}}
  {
    \providecommand{\@macCDXCIX}{{\fontfamily{lmr}\selectfont map~\oldstylenums{2010}}}

    \@ifpackageloaded{libertinus}
      {\renewcommand{\@macCDXCIX}{{\LibertinusSerifOsF map~2010}}}
      {}

    \@ifpackageloaded{libertine}
      {\renewcommand{\@macCDXCIX}{{\libertineOsF map~2010}}}
      {}
  }
